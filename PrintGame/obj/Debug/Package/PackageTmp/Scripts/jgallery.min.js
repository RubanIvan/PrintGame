...
var defaults = {
    ...
    backgroundColor: 'rgba(230, 230, 230, 0)', // String; Background color for jGallery container.; ; [ '#ffffff', 'silver' ]
    ...
    tooltipSlideshow: 'Slideshow', // String; Text of tooltip which will be displayed next to icon for play/pause slideshow.; ; [ 'Slideshow', 'Pokaz slajdow' ]
        ...
        getCssForColours: function( objOptions ) {
            ...
            return '\
                ...
                .jgallery[data-jgallery-id="' + this.intId + '"] .zoom-container:not([data-size="fill"]) .jgallery-container {\
                  background1: rgb(' + arrBg.r + ',' + arrBg.g + ', ' + arrBg.b + ');\
                }\
